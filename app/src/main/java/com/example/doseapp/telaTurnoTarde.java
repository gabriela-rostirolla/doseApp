...
public class telaTurnoTarde extends Fragment {
    ...
    private RecyclerView rv_listaTarde;
...
//                  intent.putExtra("id", id);
    ...
    protected void inicializarComponentes(View view) {
        fabAdd = view.findViewById(R.id.fab_addDiarioTarde);
        rv_listaTarde = view.findViewById(R.id.rv_listaTurnoTarde);
        spiAcao = view.findViewById(R.id.spiAcao);
        tv_nenhumCadastro = view.findViewById(R.id.tv_nenhumDiarioTarde);
    }
}